...
<p align="center">
  <b>프로그래머스</b> · <b>SWEA</b> · <b>LeetCode</b> · <b>Codeforces</b> &nbsp;|&nbsp; 🌐 한국어 / English
</p>
...
각 플랫폼의 공식 API 또는 목록 페이지를 이용해 키워드·태그·난이도로 검색합니다.
...
3. 문제 번호 입력 후 **가져오기** 클릭
   ...
   - Codeforces: `1234A` 또는 URL

### 2. 문제 검색 & 랜덤
- **검색**: 각 플랫폼에서 키워드·태그·난이도로 문제 검색
- **랜덤**: 레이팅/레벨 범위, 태그, 옵션을 설정하고 문제를 랜덤으로 뽑기
