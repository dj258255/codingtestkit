...
| # | Feature | Description |
|:-:|---------|-------------|
| 1 | [**Fetch Problems**](docs/features/fetch.md) | Fetch problem description & test cases from 4 platforms |
...
| 5 | [**Problem Search**](docs/features/search.md) | Search problems on BOJ (solved.ac) and LeetCode |
...
| 11 | [**GitHub Integration**](docs/features/github.md) | Auto-push accepted solutions to GitHub (BaekjoonHub-style) |
...
- **Algorithm Tag Chips**: Selected tags shown as chips/badges, individually removable with x
...
| # | 기능 | 설명 |
|:-:|------|------|
| 1 | [**문제 가져오기**](docs/features/fetch.md) | 4개 플랫폼에서 문제 설명 & 테스트 케이스 자동 추출 |
...
| 5 | [**문제 검색**](docs/features/search.md) | 백준 (solved.ac) 및 LeetCode 문제 검색 |
...
| 11 | [**GitHub 연동**](docs/features/github.md) | 맞은 문제 자동 GitHub 푸시 (백준허브 스타일) |
...
- **알고리즘 태그 칩**: 선택한 태그가 칩/뱃지로 표시되며, x 클릭으로 개별 제거 가능
